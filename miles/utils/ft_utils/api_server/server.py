...
from miles.utils.workers.ray_worker_manager import connect_worker_manager
...
def start_api_server(
    *,
    ...
    if "rollout" in ft_components:
        rollout_cell_ids = inference_controller.list_cell_ids()
        worker_manager = connect_worker_manager() if rollout_cell_ids else None
        for rollout_cell_id in rollout_cell_ids:
            registry.register(
                _RolloutCellHandle(
