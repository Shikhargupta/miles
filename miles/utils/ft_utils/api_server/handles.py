...
class _ActorCellHandler(_CellHandler):
    def __init__(
        ...
        *,
        ...
        group: RayTrainGroup,
        trainer_spec_names: list[str],
    ) -> None:
        self._worker_manager = worker_manager
        self._group = group
        self._trainer_spec_names = trainer_spec_names
    ...
    async def _get_cell_infos(self) -> dict[str, CellInfo]:
        return await self._worker_manager.get_cell_infos.remote(spec_names=self._trainer_spec_names)
