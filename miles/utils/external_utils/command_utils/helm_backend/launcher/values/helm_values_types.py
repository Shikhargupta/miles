...
_POOL_NAME_MAX = 40
_LONGEST_ENGINE_POOL_ID_AROUND_THE_INSTANCE = "inference-engine--99-99"
DEPLOY_INSTANCE_MAX_LENGTH = _POOL_NAME_MAX - len(_LONGEST_ENGINE_POOL_ID_AROUND_THE_INSTANCE)
_OBJECT_NAME_MAX = 63
_PORT_NAME_MAX = 15
