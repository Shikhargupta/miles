...
class RegistrationReporter:
    ...
    expected_num_cells_by_group_id: dict[str, int]
    trigger: _DebouncedIntervalTrigger = field(
    ...
    async def run(self) -> None:
        ...
        try:
            logger.info(
                ...
                f"reports them every {self.trigger.interval_seconds}s"
            )
            while True:
    ...
    def _compute_snapshot(self) -> RegistrationSnapshot:
        ...
        return RegistrationSnapshot(
            ...
            expected_num_cells_by_group_id=self.expected_num_cells_by_group_id,
