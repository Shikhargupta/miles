...
class DistBucketedWeightUpdateMixin:
    ...
    def _finalize_and_resume_engines(self, num_trained_rollouts: int) -> None:
    ...
    def update_weights(self, *, num_trained_rollouts: int) -> None:
        ...
        with timer("update_weights_implementation"):
            ...
            if not is_lora:
                ...
                update_impl = partial(self._update_weight_implementation, num_trained_rollouts=num_trained_rollouts)
        ...
        with timer("finalize_and_resume_engines"):
            self._finalize_and_resume_engines(num_trained_rollouts)
            dist.barrier(group=get_gloo_group())
