"""Protocol-neutral explicit optimizer-operation execution helpers
(codex-rollout-fullparameter-design-0810 §3.2/§3.5).

The client owns the optimizer boundary. These helpers contain no Tinker wire
...
def run_optim_controls(
    ...
    """Generic coordinator for the explicit optimizer-operation boundary (§3.5):
