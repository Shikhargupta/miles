...
from miles.utils.metric_utils import compute_metric_namespace, compute_rollout_step, namespace_metrics
...
def gather_log_data(
    ...
    if pg.rank == 0:
        ...
        reduced_log_dict, step_key = namespace_metrics(
            reduced_log_dict, namespace=compute_metric_namespace(args), step_name="rollout/step", step=step
        )
