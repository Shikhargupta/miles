...
class RayTrainGroup:
    ...
    async def _maybe_log_inference_engine_weight_checksums(self, *, rollout_id: int | None) -> None:
        ...
        check_weights_result = await self._inference_controller.check_weights.remote("checksum")
    ...
    async def set_rollout_components(self):
        await asyncio.gather(*[cell.set_rollout_components() for cell in self._cells])
