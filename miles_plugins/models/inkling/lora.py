...
# miles native-LoRA provider protocol (resolve_lora_provider dispatches Inkling
# checkpoints here; see miles.backends.megatron_utils.lora_utils).
wrap_model_provider_with_lora = wrap_model_provider_with_inkling_lora
load_lora_adapter_hf = load_inkling_lora_adapter
export_lora_hf_named = export_inkling_lora_hf_named
