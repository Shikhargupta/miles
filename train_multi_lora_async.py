...
async def main(args):
    ...
    init_tracking(args)
    inference_controller, rollout_executor, _num_rollout_per_epoch = await create_rollout_components(args, infra)
    ...
    actor_model, _ = await create_training_models(args, infra, inference_controller, rollout_executor)
