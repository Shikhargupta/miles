...
set -l run_id 260823-4629709b
set -l run_name 260823-4629709b-glm47-t2-summary23-metrics
set -l script_dir (path resolve (dirname (status filename)))

# Ensure both the submitter and Ray resolve Miles from this run's snapshot.
set -gx PYTHONPATH /root/worktrees/$run_id/miles /root/Megatron-LM
...
python $script_dir/run.py \
    ...
    --save-traces-dir /personal/$run_id/details \
