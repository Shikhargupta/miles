...
_EXPECTED_FIXED_TEMPLATES = {
    ...
    TITOTokenizerType.QWEN38_SMALL: ("qwen3.8_small_and_flash_next_fixed.jinja", {"preserve_thinking": True}),
    TITOTokenizerType.QWEN4_EXP: ("qwen3.8_small_and_flash_next_fixed.jinja", {"preserve_thinking": True}),
