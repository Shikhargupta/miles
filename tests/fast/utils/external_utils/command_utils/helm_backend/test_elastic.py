...
class TestScaling:
    def test_allows_growing_an_engine_fleet(self):
    ...
    def test_allows_growing_a_trainer_fleet(self):
    ...
    def test_allows_growing_a_fleet_that_started_with_one_cell(self):
    ...
    def test_allows_shrinking_a_fleet_back_to_one_cell(self):
    ...
    def test_allows_shrinking_a_trainer_fleet_back_to_one_cell(self):
...
class TestRefusals:
    ...
    def test_refuses_a_changed_fleet_command(self):
    ...
    def test_refuses_a_resized_fleet(self):
    ...
    def test_refuses_a_new_fleet(self):
    ...
    def test_refuses_a_disappearing_fleet(self):
...
class TestManifestScaling:
    def test_allows_a_fleet_that_only_grew(self):
...
class TestManifestRefusals:
    ...
    def test_refuses_a_changed_container_command(self):
        """A template-only edit to the launch command would relaunch the fleet as a different experiment."""
        diff = elastic.diff_manifests(
            _rendered(_objects()),
