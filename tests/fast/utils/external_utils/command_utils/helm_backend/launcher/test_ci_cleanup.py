...
class TestUninstallLeftoverCiReleases:
    ...
    def test_a_release_of_a_run_whose_id_starts_with_this_one_is_still_cleaned(self):
        """A prefix test reads another run's releases as this run's siblings and leaves them behind forever."""
        assert not entrypoint._belongs_to_run(
            "miles-run-260101-000000-000-trainer-inference", run_id="260101-000000-000"
        )
