    ...
    async def get_cell(self) -> Cell:
        return Cell(
            metadata=CellMetadata(
                name=self.cell_id,
                labels={"miles.io/cell-type": self.cell_type},
            ),
...
class MockInferenceController:
    ...
    def get_cell_phase(self, global_cell_id: str) -> str:
        return self._phase

    def get_cell_conditions(self, global_cell_id: str) -> list[dict[str, str | None]]:
        return self._conditions

    def get_cell_is_suspended(self, global_cell_id: str) -> bool:
        return self._is_suspended

    async def stop_cell(self, global_cell_id: str) -> None:
        self.stopped_cells.append(global_cell_id)

    async def start_cell(self, global_cell_id: str) -> None:
        self.started_cells.append(global_cell_id)
