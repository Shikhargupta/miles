...
from miles.utils.workers.serving.serve_actor import ServeActor, serve_until_the_server_stops
...
class TestTheRealThreadStarts:
    def test_start_rpc_server_really_spawns_a_thread(self, monkeypatch):
        ...
        monkeypatch.setattr(serve_actor_module, "serve_until_the_server_stops", lambda **kwargs: None)
        actor = ServeActor(build_worker=_build_worker())
