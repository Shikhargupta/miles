...
class TestNonExceptionExits:
    ...
    async def test_calls_in_flight_when_worker_exits_finish_by_deadline(
        ...
        """A concurrent accepted call reaches timeout or shutdown cancellation."""
        from miles.utils.workers.rpc.client import call as client_module
        ...
        try:
            ...
            assert "CancelledError" in str(error)
        else:
            raise AssertionError("concurrent call unexpectedly succeeded")
