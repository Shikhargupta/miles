...
class TestClusterBackend:
    ...
    def test_validation_accepts_kubernetes_now_that_it_provisions_workers(self):
        ...
        args = self._parse(
            ["--cluster-backend", "kubernetes", "--object-store-backend", "mooncake", "--num-rollout", "1"]
        )
    ...
    def test_a_kubernetes_run_on_the_ray_object_store_is_refused(self):
        ...
        with pytest.raises(AssertionError, match="object-store-backend mooncake"):
            miles_validate_args(args)
