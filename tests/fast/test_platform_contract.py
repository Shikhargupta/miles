...
PROVIDER_FACTORY_FN = "create_provider_factory"
...
UPPER_LAYER_NAMES = (
    ...
    "RayProviderFactory",
    "RayWorkerManager",
    "SharedK8sWorkerProvider",
    "compute_ctor_kwargs",
    "compute_specs",
    "create_provider_factory",
    "create_worker_provider_factory",
...
UPPER_LAYER_EXEMPTIONS = {
    ...
    "miles/utils/workers/worker_bootstrap.py": "the composition root of a worker process an actor wraps",
    ...
    "miles/ray/rollout/executor_handle.py": "still picks between a pod address and a ray actor handle itself",
...
class TestLayering:
    ...
    def test_an_orchestration_script_forks_the_backend_exactly_once(self, script: str):
        ...
        assert len(_calls_of(REPO_ROOT / script, PROVIDER_FACTORY_FN)) == 1
