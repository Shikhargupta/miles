...
from miles.ray.placement_group import WorkerInfra, create_rollout_components
...
def fake_components():
    ...
    async def build_controller(args, *, deployments, provider):
...
class TestCreateRolloutComponents:
    async def test_executor_is_built_after_the_router_address_is_known(self, fake_components):
        ...
        await create_rollout_components(args, WorkerInfra(pgs={}))
    ...
    async def test_returns_a_plain_controller_and_an_actor_handle(self, fake_components):
        ...
        controller, executor, _ = await create_rollout_components(args, WorkerInfra(pgs={}))
    ...
    async def test_num_rollout_derived_from_executor_epoch_length(self, fake_components):
        ...
        _, _, num_rollout_per_epoch = await create_rollout_components(args, WorkerInfra(pgs={}))
