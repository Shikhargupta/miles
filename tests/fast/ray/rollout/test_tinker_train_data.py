...
class TestConvert:
    def test_tinker_batch_skips_rewards_and_routes_by_plan_slot(self):
        metadata = batch_plan_to_metadata([plan_entry("A", 5, sample_count=2)])
    ...
    def test_adapter_less_samples_keep_the_generic_tinker_contract(self):
        ...
        metadata = batch_plan_to_metadata([plan_entry("A", 0, kind="forward")])
    ...
    def test_client_channels_survive_the_dp_shard_split(self):
        ...
        metadata = batch_plan_to_metadata([plan_entry("A", 0, sample_count=2)])
