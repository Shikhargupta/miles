...
class TestResolveRouterAddrs:
    ...
    async def test_a_router_port_without_an_address_is_rejected_too(self):
        """Half a router config is still a run that would talk to a router miles did not deploy."""
        args = make_args(sglang_router_ip=None, sglang_router_port=3000, sglang_model_routers=None)
