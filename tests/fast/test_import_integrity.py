"""Import integrity: every miles-internal import site (incl. function-local) resolves, and optional namespaces import when present."""
...
def test_optional_namespace_modules_all_import():
