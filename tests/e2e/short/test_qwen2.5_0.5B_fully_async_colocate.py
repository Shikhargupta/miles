...
register_cuda_ci(est_time=400, suite="stage-c-2-gpu-h200", labels=["short", "fully-async", "colocate"])

FEW_GPU = U.get_bool_env_var("MILES_TEST_FEW_GPU", "0")

MODEL_NAME = "Qwen2.5-0.5B-Instruct"
MODEL_TYPE = "qwen2.5-0.5B"
NUM_GPUS = 1 if FEW_GPU else 2
...
def execute():
    ...
    misc_args = (
        ...
        # HF-format --ref-load requires the bridge loader.
