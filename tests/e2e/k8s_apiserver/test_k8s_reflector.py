...
class TestCursorExpiryAgainstAnApiserver:
    async def test_a_compacted_cursor_is_reported_in_a_shape_the_reflector_reads_as_expired(
        ...
        await _write_pods_outside_the_selector(expiring_apiserver_core_v1, expiring_apiserver_namespace)
...
async def _write_pods_outside_the_selector(core_v1_api: kubernetes_client.CoreV1Api, namespace: str) -> None:
