...
- If the run dies, relaunch the same command — training resumes from the last
  checkpoint.
- The [Miles dashboard](/user-guide/monitoring#miles-dashboard) records what every GPU was doing
...
| Are GPUs saturated? | The [Miles dashboard](/user-guide/monitoring#miles-dashboard) GPU timeline |
