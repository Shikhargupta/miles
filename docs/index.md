...
- **Agentic environments.** Train coding and computer-use agents on environments from
  Harbor, HUD, NeMo Gym, OpenEnv, Verifiers and more: each ecosystem has a connector at
  the rollout layer that fits it, and task sandboxes run on AgentENV, Daytona, E2B or
