...
| `run-glm47-flash-agentic-async.py` | Disaggregated fully asynchronous launcher; training and one SGLang engine on disjoint GPUs of a single node (default 4 + 2). |
