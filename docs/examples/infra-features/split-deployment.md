---
title: "Split Deployment Example"
description: "Installs one run as several helm releases — trainer, engines and orchestration script apart."
# Generated from examples/infra_features/split_deployment/README.md by scripts/tools/sync_example_docs.py. Edit that README, not this file.
---
