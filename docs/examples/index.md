...
- **[tinker_backend](/examples/tinker-backend)**: Multi-adapter LoRA served through the tinker-compatible operation backend (client-driven forward_backward/optim_step).
