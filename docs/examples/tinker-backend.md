---
title: "Tinker-compatible backend"
description: "Multi-adapter LoRA served through the tinker-compatible operation backend (client-driven forward_backward/optim_step)."
# Generated from examples/tinker_backend/README.md by scripts/tools/sync_example_docs.py. Edit that README, not this file.
---
